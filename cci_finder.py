...
parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter,epilog='\nIf logging in to wlc (not using \'-f\' option) this program requires \'pexpect\'. Eg easy_install pexpect.\n\nExample > python cci_finder.py -wlc controller1.test.net\nExample (2.4GHz neighbors)> python cci_finder.py -r 2.4 -wlc controller1.test.net \nExample (5GHz neighbors, specifying filename)> python cci_finder.py -f cli_output.txt\nExample (5GHz neighbors, specifying SNR of 20) > python cci_finder.py -wlc controller1.net -s 20 \nDefault (if no option specified) is 5Ghz neighbors only at 14dB SNR and prompting user for controller FQDN & credentials\n\n')
